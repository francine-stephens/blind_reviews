...
## Set Paths
wd <- getwd()
output_path <- "/03-2022-1/"  #you want to write this to the monthly file
...
* If Intuit reviews > 30 then ocnsider using, but include note on review counts in deck. 
...
```{r summary stats intuit and competitors}
